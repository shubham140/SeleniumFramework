...
public class PostAPITest extends TestBase{
	...
	public void postAPITest() throws JsonGenerationException, JsonMappingException, IOException{
		...
		Users users = new Users("gpuser1", "45000", "25"); //expected users obejct
		
		//object to json file:
		mapper.writeValue(new File("E:\\study\\libs\\APIAutomationUsingHTTPClient-master\\src\\main\\java\\com\\qa\\data\\users.json"), users);
